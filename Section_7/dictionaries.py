...
# Need to create a key-value if one doesn't exist in the dictionary?
# use variable.setdefault(key, value)
eggs.setdefault('color', 'black') # creates key with value black, you will not be able to change it if the value exists. 

### Count the instances of a letter in a string program ###

message = 'It was a bright cold day in April, and the clocks were striking thirteen.'
count = {} # key-value pairs for each letter and how many times it appears in the variable, i.e. 'r': 12.

for character in message.upper():  # sets variable character, makes all letters uppercase
    count.setdefault(character, 0) #creates new key character, sets default 0 for each character in message.
    count[character] = count[character] +1 # count dictionary values initialized to increment as it loops
print(count) # print the count out for the dictionary

### Great, let's do this for a big book ###
...
for character in message.upper():  # sets variable character, makes all letters uppercase
    count.setdefault(character, 0) #creates new key character, sets default 0 for each character in message.
    count[character] = count[character] +1 # count dictionary values initialized to increment as it loops
pprint.pprint(count) # print the count out for the dictionary in a cleaner format ordered.

# need it as a string?

rjtext = pprint.pformat(count) # assigns rjtext the string format of count dictionary
print(rjtext)
